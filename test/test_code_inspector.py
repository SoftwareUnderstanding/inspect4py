...
class Test(unittest.TestCase):
    ...
    def test_call_list_dynamic_func(self):
        dictionary={'functions': {'func_2': {'local': ['test_dynamic_func.func_1']}, 'main': {'local': ['test_dynamic_func.func_2', 'print']}}, 'body': {}}
    ...
    def test_call_list_dynamic_body_import(self):
        dictionary={'functions': {'func_3': {'local': ['test_dynamic_func.func_1']}}, 'body': {'local': ['test_dynamic_import.func_3', 'print']}}
    ...
    def test_call_list_dynamic_body_from_import(self):
        dictionary={'functions': {'func_3': {'local': ['test_dynamic_func.func_1']}}, 'body': {'local': ['test_dynamic_from_import.func_3', 'print']}}
    ...
    def test_call_list_dynamic_import_method_varibale(self):
        dictionary={'functions': {'func_2': {'local': ['test_dynamic_method_variable.MyClass.func_1']}, 'main': {'local': ['test_dynamic_method_variable.MyClass', 'test_dynamic_method_variable.func_2', 'print']}}, 'body': {}, 'MyClass': {}}
